...
<html lang="en">
<head>
    <title>Code coverage report for watcher/abstract.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">all files</a> / <a href="index.html">watcher/</a> abstract.js
    </h1>
    <div class='clearfix'>
...
<span class="cstat-no" title="statement not covered" >            return;</span>
        ...
        Object.keys(default_1.default).forEach(function (key) {
            var value = options[key] || <span class="branch-1 cbranch-no" title="branch not covered" >_this.options[key];</span>
